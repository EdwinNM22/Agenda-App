...
export const BANCO_INSTRUCTIONS: string[] = [
  ...
  "query_banco resource ingresos | egresos | movimientos: listado de movimientos. Cada fila incluye monto, fecha, motivo (qué es el movimiento), registradoPor; ingresos incluyen ingresoTipoLabel; egresos incluyen destinoLabel. Sin filtro de período en params → listado reciente hasta el límite (como la pestaña Banco).",
