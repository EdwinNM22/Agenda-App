...
export const buildAtlasInstructions = (ctx: SessionContext): string[] => [
  ...
  "Recursos query_prestamo: cuotas, cuotas-vencidas, creditos, clientes, pagos, desembolsos, caja-chica, caja-chica-detalle, ingresos, egresos. NO existe resource resumen ni liquidez en Isi.",
  "«Qué hay en Atlas» / «cómo está Atlas» sin más detalle: caja-chica con periodo=hoy como base; si hace falta contexto, pagos/cuotas/desembolsos del mismo día. Prohibido KPIs de cartera global (total invertido, cartera recuperada/pendiente acumulada, liquidación).",
  "CAJA EN ATLAS: caja-chica del período (saldo inicial, cuánto hay, ingresos y egresos del período; desembolsos en egresos). Prohibido liquidez, liquidación y totales de cartera global salvo petición explícita del usuario.",
  ...
  "Sin período explícito en caja-chica, ingresos, egresos, desembolsos, pagos, cuotas o creditos, usa periodo=hoy. Histórico o totales globales solo si lo piden explícitamente (todo el tiempo, desde el inicio, total acumulado, toda la cartera, etc.).",
