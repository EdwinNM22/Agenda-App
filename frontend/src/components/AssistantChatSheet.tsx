  ...
  return (
    ...
    >
      <SheetContent
        side="bottom"
        showCloseButton
        className="assistant-chat-sheet z-[70] flex h-full min-h-0 w-full flex-col gap-0 overflow-hidden border-t p-0 sm:mx-auto sm:max-w-lg"
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="assistant-chat-composer-bar shrink-0 border-t bg-popover px-5 pt-2 pb-[max(var(--k-safe-area-bottom),0.75rem)] backdrop-blur-sm">
