  ...
  return (
    ...
    >
      <SheetContent
        side="bottom"
        showCloseButton
        className="assistant-chat-sheet z-[70] flex h-full min-h-0 w-full flex-col gap-0 overflow-hidden border-t p-0 pb-[max(var(--k-safe-area-bottom),0.75rem)] sm:mx-auto sm:max-w-lg"
      >
